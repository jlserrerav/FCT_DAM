...
public class EliminarSedeAdmin implements WindowListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
        	...
        	SedeEmpresaAdministracion sE = new SedeEmpresaAdministracion();
        	sE.setVisible(true);
        	ventana.dispose();
        }
    }
