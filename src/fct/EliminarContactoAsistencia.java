...
public class EliminarContactoAsistencia extends JFrame implements WindowListener, ActionListener {
    /**
	 * 
	 */
    ...
    public EliminarContactoAsistencia() {
    	setTitle("Eliminar Contacto de Asistencia"); // Título de la ventana
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new EliminarContactoAsistencia();
        });
    }
}
