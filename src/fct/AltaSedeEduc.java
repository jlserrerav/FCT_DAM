...
public class AltaSedeEduc extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AltaSedeEduc frame = new AltaSedeEduc();
     ...
     */
    public AltaSedeEduc() {
        setTitle("Alta de Sede de Educación"); // Título de la ventana
        ...
        conexion.rellenarChoiceEmpresaEduc(comboBox);
    ...
    public void actionPerformed(ActionEvent e) {
		...
		{
			SedeEducacion a = new SedeEducacion();
			a.setVisible(true);
