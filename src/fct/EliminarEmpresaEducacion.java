...
public class EliminarEmpresaEducacion implements WindowListener, ActionListener {
    ...
    public EliminarEmpresaEducacion() {
    ...
    private void cargarEmpresas() {
        ...
        empresas = conexion.obtenerListadoEmpresaEducacion2();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
        	...
        	EmpresasEducacion eEO = new EmpresasEducacion();
            eEO.setVisible(true);
            ventana.dispose();
            ventana.dispose();
        }
