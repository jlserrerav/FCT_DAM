...
public class EditarContactoEmpresaEnfermeria  implements WindowListener, ActionListener {
    ...
    public EditarContactoEmpresaEnfermeria() {
        ...
        contactos = conexion.obtenerListadoContactosEmpresaEnfermeria();
        ...
        if (e.getSource().equals(btnEditar)) {
            ...
            for (int i = 0; i < checkBoxes.length; i++) {
                if (checkBoxes[i].isSelected()) {
                    ...
                    conexion.rellenarChoiceEmpresaEnfermeria(comboEmpresas);
            ...
            ventana.setVisible(false);
            ContacoEmpresaEnfermeria c = new ContacoEmpresaEnfermeria();
            c.setVisible(true);
        }
    }
    ...
    public static void main(String[] args) {
        new EditarContactoEmpresaEnfermeria();
    }
}
