...
public class EditarPracticaEduc extends JFrame implements WindowListener, ActionListener {
	/**
	 * 
	 */
	...
	public EditarPracticaEduc() {
    	setTitle("Editar Práctica de Educación"); // Título de la ventana
		...
		practicas = conexion.obtenerListadoPracticaEduc(); // Método para obtener las prácticas de la base de datos
	    ...
	    if (e.getSource().equals(btnEditar)) {
	        ...
	        for (int i = 0; i < checkBoxes.length; i++) {
	            if (checkBoxes[i].isSelected()) {
	                ...
	                conexion.rellenarChoiceSedesEduc(comboSedes); // Método para rellenar el combo con sedes
	                ...
	                conexion.rellenarChoiceContactosEduc(comboContactos); // Método para rellenar el combo con contactos
