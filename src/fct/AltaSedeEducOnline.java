...
public class AltaSedeEducOnline extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AltaSedeEducOnline frame = new AltaSedeEducOnline();
     ...
     * Create the frame.
     */
    public AltaSedeEducOnline() {
        setTitle("Alta de Sede de Educación Online"); // Título de la ventana
        ...
        conexion.rellenarChoiceEmpresaEducOnline(comboBox);
    ...
    public void actionPerformed(ActionEvent e) {
		...
		{
			SedeEducacionOnline a = new SedeEducacionOnline();
			a.setVisible(true);
