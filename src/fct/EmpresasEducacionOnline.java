...
public class EmpresasEducacionOnline extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmpresasEducacionOnline frame = new EmpresasEducacionOnline();
	...
	public EmpresasEducacionOnline() {    	
		setTitle("Empresa Educación Online"); // Título de la ventana
		...
		conexion.rellenarListadoEmpresaEducacionOnline(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorCIF(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorDireccion(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorLocalidad(textArea);
                        break;
                    case 4: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorRepresentante(textArea);
                        break;
                    case 5: // DNI Representante
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorDNIRepresentante(textArea);
                        break;
                    case 6: // Email
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorEmail(textArea);
                        break;
                    case 7: // Teléfono
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaEducacionOnlinePorTelefono(textArea);
                        break;
                    default:
                        break;
                }
		...
		btnNewButton_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		AltaEmpresaEducacionOnline menuPrincipal = new AltaEmpresaEducacionOnline();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
        ...
        JButton btnNewButton_3 = new JButton("Crear Excel");
        btnNewButton_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               EliminarEmpresaEducacionOnline menuPrincipal = new EliminarEmpresaEducacionOnline();
        ...
        btnEditar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EditarEmpresaEducacionOnline menuPrincipal = new EditarEmpresaEducacionOnline();
                menuPrincipal.ventana.setVisible(true);
                dispose();  // Cierra la ventana actual
            }
        });
