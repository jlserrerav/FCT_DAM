...
public class EditarSedeAdmin  implements WindowListener, ActionListener {
    ...
    public EditarSedeAdmin() {
        ...
        sedes = conexion.obtenerListadoSedesEmpresaAdmin();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            ventana.setVisible(false);
            SedeEmpresaAdministracion c = new SedeEmpresaAdministracion();
            c.setVisible(true);
        }
    }
