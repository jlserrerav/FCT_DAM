...
public class AlumnasErasmus extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AlumnasErasmus frame = new AlumnasErasmus();
    ...
    public AlumnasErasmus() {
    	setTitle("Alumnas en Erasmus"); // Título de la ventana
        ...
        btnNewButton_2.setBounds(906, 649, 161, 37); // Ajusta la posición del botón
        ...
        btnMoverAlumnas.setBounds(902, 720, 224, 23); // Ajusta la posición del botón
        ...
        btnEditar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
                EdiarAlumnaErasmus mnuVolver = new EdiarAlumnaErasmus();
                mnuVolver.setVisible(true);
            }
        });
    ...
    private void rellenarListadoAlumnasConCheckBox() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmus();
    ...
    private void rellenarListadoAlumnasConCheckBoxPorApellido() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorApellido();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorDni() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorDni();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorDireccion() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorDireccion();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorTelefono() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorTelefono();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorEmailPersonal() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorEmailPersonal();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorEmailCentro() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorEmailCentro();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorCiclo() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorCiclo();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorCurso() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorCurso();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorAñoInicio() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorAñoInicio();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorAñoFin() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorAñoFin();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorFechaNacimiento() {
        List<String> alumnas = conexion.obtenerListadoAlumnasErasmusOrdenadasPorFechaNacimiento();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
