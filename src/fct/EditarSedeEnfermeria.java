...
public class EditarSedeEnfermeria implements WindowListener, ActionListener {
    ...
    public EditarSedeEnfermeria() {
        ...
        sedes = conexion.obtenerListadoSedesEmpresaEnf();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            ventana.setVisible(false);
            SedeEnfermeria c = new SedeEnfermeria();
            c.setVisible(true);
        }
    }

    public static void main(String[] args) {
        new EditarSedeEnfermeria();
    }
}
