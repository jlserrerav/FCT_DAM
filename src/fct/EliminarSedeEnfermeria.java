...
public class EliminarSedeEnfermeria implements WindowListener, ActionListener {
    /**
	 * 
	 */
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            SedeEnfermeria se = new SedeEnfermeria();
            se.setVisible(true);
            ventana.dispose();
        }
    }
