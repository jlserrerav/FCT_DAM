...
public class EditarPracticaAsis extends JFrame implements WindowListener, ActionListener {
	/**
	 * 
	 */
	...
	public EditarPracticaAsis() {
    	setTitle("Editar Práctica de Asisencia"); // Título de la ventana
		...
		practicas = conexion.obtenerListadoPracticaAsis(); // Método para obtener las prácticas de la base de datos
	    ...
	    if (e.getSource().equals(btnEditar)) {
	        ...
	        for (int i = 0; i < checkBoxes.length; i++) {
	            if (checkBoxes[i].isSelected()) {
	                ...
	                conexion.rellenarChoiceSedesAsis(comboSedes); // Método para rellenar el combo con sedes
	                ...
	                conexion.rellenarChoiceContactosAsis(comboContactos); // Método para rellenar el combo con contactos
