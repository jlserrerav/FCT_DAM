...
public class EditarEmpresaAsistencia implements WindowListener, ActionListener {
    ...
    public EditarEmpresaAsistencia() {
        ...
        empresas = conexion.obtenerListadoEmpresaAsistencia2();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
        	...
        	EmpresaAsistencia eAsis = new EmpresaAsistencia();
        	eAsis.setVisible(true);
            ventana.dispose();
        }
    }
