...
public class AltaSedeEnfermeria extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AltaSedeEnfermeria frame = new AltaSedeEnfermeria();
     ...
     * Create the frame.
     */
	    public AltaSedeEnfermeria() {
	        setTitle("Alta de Sede de Enfermeria"); // Título de la ventana
	        ...
	        conexion.rellenarChoiceEmpresaEnfermeria(comboBox);
    ...
    public void actionPerformed(ActionEvent e) {
		...
		{
			SedeEnfermeria a = new SedeEnfermeria();
			a.setVisible(true);
