...
public class PracticaAsis extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                PracticaAsis frame = new PracticaAsis();
    ...
    public PracticaAsis() {
    	setTitle("Prácticas de Asistencia"); // Título de la ventana
        ...
        conexion.rellenarListadoPracticasAsistenciaPorNombreAlumna(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoPracticasAsistenciaPorNombreSede(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoPracticasAsistenciaPorNombreContacto(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoPracticasAsistenciaPorHorario(textArea);
                        break;
                    default:
                        break;
                }
        ...
        btnNewButton_2.addActionListener(e -> {
            AltaPracticaAsis menuPrincipal = new AltaPracticaAsis();
            menuPrincipal.setVisible(true);
            dispose();  // Cierra la ventana actual
        });
        ...
        btnNewButton_3.addActionListener(e -> {
            EliminarPracticaAsis menuPrincipal = new EliminarPracticaAsis();
        ...
        btnEditar.addActionListener(e -> {
            EditarPracticaAsis menuPrincipal = new EditarPracticaAsis();
            menuPrincipal.ventana.setVisible(true);
            dispose();  // Cierra la ventana actual
        });
