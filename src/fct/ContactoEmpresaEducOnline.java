...
public class ContactoEmpresaEducOnline extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ContactoEmpresaEducOnline frame = new ContactoEmpresaEducOnline();
    ...
    public ContactoEmpresaEducOnline() {
    	setTitle("Contactos de Educación Online"); // Título de la ventana
        ...
        conexion.rellenarListadoContactoEmpresaEducacionOnline(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaEducacionOnlinePorApellido(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaEducacionOnlinePorDni(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaEducacionOnlinePorTelefono(textArea);
                        break;
                    case 4: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaEducacionOnlinePorEmail(textArea);
                        break;
                    case 5: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaEducacionOnlinePorEmpresa(textArea);
                        break;
                    default:
                        break;
                }
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		AltaContactoEmpresaEducOnline menuPrincipal = new AltaContactoEmpresaEducOnline();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		EliminarContactoEducacionOnline menuPrincipal = new EliminarContactoEducacionOnline();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
