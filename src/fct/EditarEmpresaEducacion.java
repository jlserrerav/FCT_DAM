...
public class EditarEmpresaEducacion  implements WindowListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            EmpresasEducacion eA = new EmpresasEducacion();
            eA.setVisible(true);
            ventana.dispose();
        }
    }
