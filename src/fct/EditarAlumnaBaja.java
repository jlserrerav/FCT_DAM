...
public class EditarAlumnaBaja extends JFrame implements WindowListener, ActionListener {
	...
	public EditarAlumnaBaja() {
    	setTitle("Editar Alumnas de Baja"); // Título de la ventana
		...
		alumnas = conexion.obtenerListadoAlumnasBaja();
