...
public class EliminarPracticaEnf implements WindowListener, ActionListener {
    ...
    private void cargarPracticas() {
        ...
        Practicas = conexion.obtenerListadoPracticaEnf();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            PracticaEnf pa = new PracticaEnf();
            pa.setVisible(true);
            ventana.dispose();
        }
    }
