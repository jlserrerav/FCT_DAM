...
public class EliminarSedeEducacionOnline extends JFrame implements WindowListener, ActionListener {
    /**
	 * 
	 */
    ...
    public EliminarSedeEducacionOnline() {
    	setTitle("Eliminar Sede de Educación Online"); // Título de la ventana
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new EliminarSedeEducacionOnline();
        });
    }
}
