...
public class EditarContactoEmpresaAdministracion extends JFrame implements WindowListener, ActionListener {
    ...
    public EditarContactoEmpresaAdministracion() {
        setTitle("Editar Contacto de Administración"); // Título de la ventana
        ...
        contactos = conexion.obtenerListadoContactosEmpresaAdmin();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            if (countSelected > 1) {
                JOptionPane.showMessageDialog(this, "Solo puedes editar un contacto a la vez.", "Error", JOptionPane.ERROR_MESSAGE);
            ...
            for (int i = 0; i < checkBoxes.length; i++) {
                if (checkBoxes[i].isSelected()) {
                    ...
                    if (contactoDatos.length < 9) { // Comprobar que hay 9 elementos
                        JOptionPane.showMessageDialog(this, "Error en los datos del contacto.", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    conexion.rellenarChoiceEmpresaAdmin(comboEmpresas);
            ...
            ContactoEmpresaAdministracion c = new ContactoEmpresaAdministracion(); // Instancia la ventana anterior
            c.setVisible(true); // Muestra la ventana anterior
        }
    }

    public static void main(String[] args) {
        new EditarContactoEmpresaAdministracion();
    }
}
