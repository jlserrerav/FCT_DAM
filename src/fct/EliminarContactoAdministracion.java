...
public class EliminarContactoAdministracion implements WindowListener, ActionListener {
    ...
    public EliminarContactoAdministracion() {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            ContactoEmpresaAdministracion ca = new ContactoEmpresaAdministracion();
            ca.setVisible(true);
            ventana.dispose();
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new EliminarContactoAdministracion();
        });
    }
}
