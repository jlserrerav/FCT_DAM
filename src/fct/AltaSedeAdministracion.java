...
public class AltaSedeAdministracion extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AltaSedeAdministracion frame = new AltaSedeAdministracion();
     ...
     * Create the frame.
     */
    public AltaSedeAdministracion() {
        setTitle("Alta de Sede de Administración"); // Título de la ventana
        ...
        conexion.rellenarChoiceEmpresaAdmin(comboBox);
    ...
    public void actionPerformed(ActionEvent e) {
		...
		{
			SedeEmpresaAdministracion a = new SedeEmpresaAdministracion();
			a.setVisible(true);
