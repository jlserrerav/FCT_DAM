...
public class EliminarEmpresaEducacionOnline  implements WindowListener, ActionListener {
    ...
    public EliminarEmpresaEducacionOnline() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new EliminarEmpresaEducacionOnline();
        });
    }
}
