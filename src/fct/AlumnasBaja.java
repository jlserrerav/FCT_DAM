...
public class AlumnasBaja extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AlumnasBaja frame = new AlumnasBaja();
    ...
    public AlumnasBaja() {
    	setTitle("Alumnas de Baja"); // Título de la ventana
     ...
     // Panel para las alumnas con scroll
        ...
        btnEditar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	dispose();
                EditarAlumnaBaja mnuVolver = new EditarAlumnaBaja();
                mnuVolver.setVisible(true);
            }
        });
    ...
    private void rellenarListadoAlumnasConCheckBox() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBaja();
    ...
    private void rellenarListadoAlumnasConCheckBoxPorApellido() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorApellido();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorDni() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorDni();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorDireccion() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorDireccion();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorTelefono() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorTelefono();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorEmailPersonal() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorEmailPersonal();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorEmailCentro() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorEmailCentro();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorCiclo() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorCiclo();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorCurso() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorCurso();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorAñoInicio() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorAñoInicio();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorAñoFin() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorAñoFin();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
    ...
    private void rellenarListadoAlumnasConCheckBoxPorFechaNacimiento() {
        List<String> alumnas = conexion.obtenerListadoAlumnasBajaOrdenadasPorFechaNacimiento();
        for (String alumna : alumnas) {
            JCheckBox checkBox = new JCheckBox(alumna);
            String[] datosAlumna = alumna.split(" ");
            String idAlumna = datosAlumna[0];
