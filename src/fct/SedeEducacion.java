...
public class SedeEducacion extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                SedeEducacion frame = new SedeEducacion();
    ...
    public SedeEducacion() {
    	setTitle("Sedes de Educación"); // Título de la ventana
        ...
        conexion.rellenarListadoSedeEducacionPorNombreSede(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoSedeEducacionPorDireccion(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoSedeEducacionPorTelefono(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoSedeEducacionPorObservaciones(textArea);
                        break;
                    case 4: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoSedeEducacionPorEmpresa(textArea);
                        break;
                    default:
                        break;
                }
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		EliminarSedeEducacion menuPrincipal = new EliminarSedeEducacion();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
        ...
        btnEditar.addActionListener(e -> {
            EditarSedeEduc menuPrincipal = new EditarSedeEduc();
            menuPrincipal.setVisible(true);
            dispose();  // Cierra la ventana actual
        });
