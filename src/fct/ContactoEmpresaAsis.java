...
public class ContactoEmpresaAsis extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ContactoEmpresaAsis frame = new ContactoEmpresaAsis();
    ...
    public ContactoEmpresaAsis() {
    	setTitle("Contactos de Asistencia"); // Título de la ventana
        ...
        conexion.rellenarListadoContactoEmpresaAsistencia(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaAsistenciaPorApellido(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaAsistenciaPorDni(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaAsistenciaPorTelefono(textArea);
                        break;
                    case 4: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaAsistenciaPorEmail(textArea);
                        break;
                    case 5: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoContactoEmpresaAsistenciaPorEmpresa(textArea);
                        break;
                    default:
                        break;
                }
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		AltaContactoEmpresaAsis menuPrincipal = new AltaContactoEmpresaAsis();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		EliminarContactoAsistencia menuPrincipal = new EliminarContactoAsistencia();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
