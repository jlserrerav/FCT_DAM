...
public class EliminarContactoEducacion extends JFrame implements WindowListener, ActionListener {
    /**
	 * 
	 */
    ...
    public EliminarContactoEducacion() {
    	setTitle("Eliminar Contacto de Educación"); // Título de la ventana
