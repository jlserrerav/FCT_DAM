...
public class EmpresaAsistencia extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EmpresaAsistencia frame = new EmpresaAsistencia();
    ...
    public EmpresaAsistencia() {
    	setTitle("Empresa Asistencia"); // Título de la ventana
        ...
        conexion.rellenarListadoEmpresaAsistencia(textArea);
        ...
        choiceOrdenar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (selectedIndex) {
                    ...
                    case 1: // CIF
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorCIF(textArea);
                        break;
                    case 2: // Dirección
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorDireccion(textArea);
                        break;
                    case 3: // Localidad
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorLocalidad(textArea);
                        break;
                    case 4: // Representante
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorRepresentante(textArea);
                        break;
                    case 5: // DNI Representante
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorDNIRepresentante(textArea);
                        break;
                    case 6: // Email
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorEmail(textArea);
                        break;
                    case 7: // Teléfono
                        textArea.setText("");
                        conexion.rellenarListadoEmpresaAsistenciaPorTelefono(textArea);
                        break;
                    default:
                        break;
                }
        ...
        btnNewButton_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		AltaEmpresaAsistencia menuPrincipal = new AltaEmpresaAsistencia();
                menuPrincipal.setVisible(true);
                dispose();  // Cierra la ventana actual
        	}
        });
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EliminarEmpresaAsistencia menuPrincipal = new EliminarEmpresaAsistencia();
        ...
        btnEditar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                EditarEmpresaAsistencia menuPrincipal = new EditarEmpresaAsistencia();
                menuPrincipal.ventana.setVisible(true);
                dispose();  // Cierra la ventana actual
            }
        });
