...
public class EliminarPracticaEduc implements WindowListener, ActionListener {
    ...
    private void cargarPracticas() {
        ...
        Practicas = conexion.obtenerListadoPracticaEduc();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            PracticaEduc pa = new PracticaEduc();
            pa.setVisible(true);
            ventana.dispose();
        }
    }
