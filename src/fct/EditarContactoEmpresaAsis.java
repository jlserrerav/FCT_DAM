...
public class EditarContactoEmpresaAsis extends JFrame implements WindowListener, ActionListener {
    ...
    public EditarContactoEmpresaAsis() {
    	setTitle("Editar Contacto de Asistencia"); // Título de la ventana
        ...
        contactos = conexion.obtenerListadoContactosEmpresaAsis();
        ...
        if (e.getSource().equals(btnEditar)) {
            ...
            for (int i = 0; i < checkBoxes.length; i++) {
                if (checkBoxes[i].isSelected()) {
                    ...
                    conexion.rellenarChoiceEmpresaAsis(comboEmpresas);
            ...
            ventana.setVisible(false);
            ContactoEmpresaAsis ca = new ContactoEmpresaAsis();
            ca.setVisible(true);
        }
    }
