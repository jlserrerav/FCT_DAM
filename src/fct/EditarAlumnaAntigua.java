...
public class EditarAlumnaAntigua extends JFrame implements WindowListener, ActionListener {
	...
	public EditarAlumnaAntigua() {
    	setTitle("Editar Alumnas Antiguas"); // Título de la ventana
		...
		alumnas = conexion.obtenerListadoAntiguasAlumnas();
	...
	private void cargarAlumnas() {
        ...
        alumnas = conexion.obtenerListadoAlumnas();
        checkBoxes = new JCheckBox[alumnas.size()];
        panelAlumnas.setPreferredSize(new Dimension(300, alumnas.size() * 30)); // Ajusta las proporciones al tamaño de Alumna
