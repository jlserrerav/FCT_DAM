...
public class EditarSedeAsis extends JFrame implements WindowListener, ActionListener {
    ...
    public EditarSedeAsis() {
    	setTitle("Editar Sede de Asistencia"); // Título de la ventana
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            ventana.setVisible(false);
            SedeAsistencia c = new SedeAsistencia();
            c.setVisible(true);
        }
    }
