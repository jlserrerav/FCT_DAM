...
public class EditarSedeEduc extends JFrame implements WindowListener, ActionListener {
    ...
    public EditarSedeEduc() {
    	setTitle("Editar Sede de Educación"); // Título de la ventana
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            ventana.setVisible(false);
            SedeEducacion c = new SedeEducacion();
            c.setVisible(true);
        }
    }
