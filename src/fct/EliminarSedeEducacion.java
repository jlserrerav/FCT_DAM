...
public class EliminarSedeEducacion extends JFrame implements WindowListener, ActionListener {
    /**
	 * 
	 */
    ...
    public EliminarSedeEducacion() {
    	setTitle("Eliminar Sede de Educación"); // Título de la ventana
    ...
    private void cargarSedes() {
        ...
        Sedes = conexion.obtenerListadoSedesEmpresaEdu();
