...
public class EliminarEmpresaAsistencia  implements WindowListener, ActionListener {
    ...
    public EliminarEmpresaAsistencia() {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            EmpresaAsistencia ea = new EmpresaAsistencia();
            ea.setVisible(true);
            ventana.dispose();
        }
    }
