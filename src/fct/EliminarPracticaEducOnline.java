...
public class EliminarPracticaEducOnline implements WindowListener, ActionListener {
    ...
    public EliminarPracticaEducOnline() {
    ...
    private void cargarPracticas() {
        ...
        Practicas = conexion.obtenerListadoPracticaEducOn();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            PracticaEducOnline pa = new PracticaEducOnline();
            pa.setVisible(true);
            ventana.dispose();
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new EliminarPracticaEducOnline();
        });
    }
}
