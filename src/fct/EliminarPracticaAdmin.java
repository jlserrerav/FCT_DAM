...
public class EliminarPracticaAdmin implements WindowListener, ActionListener {
    ...
    private void cargarPracticas() {
        ...
        Practicas = conexion.obtenerListadoPracticaAdmin();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEliminar)) {
            ...
            PracticaAdmin pa = new PracticaAdmin();
            pa.setVisible(true);
            ventana.dispose();
        }
    }
