...
public class EditarPracticaEducOnline extends JFrame implements WindowListener, ActionListener {
	/**
	 * 
	 */
	...
	public EditarPracticaEducOnline() {
    	setTitle("Editar Práctica de Educación Online"); // Título de la ventana
		...
		practicas = conexion.obtenerListadoPracticaEducOn(); // Método para obtener las prácticas de la base de datos
	    ...
	    if (e.getSource().equals(btnEditar)) {
	        ...
	        for (int i = 0; i < checkBoxes.length; i++) {
	            if (checkBoxes[i].isSelected()) {
	                ...
	                JDialog dlgEdicion = new JDialog(this, "Edición de Práctica", true);
	                ...
	                conexion.rellenarChoiceSedesEducOnline(comboSedes); // Método para rellenar el combo con sedes
	                ...
	                conexion.rellenarChoiceContactosEducOnline(comboContactos); // Método para rellenar el combo con contactos
