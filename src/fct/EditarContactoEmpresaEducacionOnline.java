...
public class EditarContactoEmpresaEducacionOnline extends JFrame implements WindowListener, ActionListener {
    ...
    public EditarContactoEmpresaEducacionOnline() {
    	setTitle("Editar Contacto de Educación Online"); // Título de la ventana
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnEditar)) {
            ...
            ventana.setVisible(false);
            ContactoEmpresaEducOnline c = new ContactoEmpresaEducOnline();
            c.setVisible(true);
        }
    }
    ...
    public static void main(String[] args) {
        new EditarContactoEmpresaEducacionOnline();
    }
}
